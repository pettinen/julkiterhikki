...
async function main() {
  ...
  // TODO: Allow filtering by rights. Example request data:
  // ["^ ","~:oikeudet",[["^ ","~:nimi",["^ ","~:FI","sosionomi","~:SV","socionom","~:EN","bachelor of social services"],"~:rajoituksia",false]],"~:etunimet","","~:sukunimi",""]
